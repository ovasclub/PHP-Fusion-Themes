...
class Dashboard {
    ...
    private function renderDashboard() {
        ...
        $html .= fusion_get_function('opentable', $locale['250'], '', FALSE);
            ...
            $panels = [
                'registered'   => ['link' => '', 'title' => $locale['251'], 'icon' => 'users'],
                'cancelled'    => ['link' => 'status=5', 'title' => $locale['263'],'yellow', 'icon' => 'user-times'],
                    ...
                    $html .= '<div class="col-xs-'.$grid['mobile'].' col-sm-'.$grid['tablet'].' col-md-'.$grid['laptop'].' col-lg-'.$grid['desktop'].' block">';
                        $html .= '<div class="small-box">';
                            $html .= '<div class="inner clearfix">';
                                ...
                                $html .= '<p class="text-smaller pull-right" style="position: relative;z-index: 3;">'.$block['title'].'</p>';
                            $html .= '</div>';
                                ...
                                $html .= '<div class="info-box-content">';
                                    ...
                                    if (!empty($module['stats'])) {
                                        foreach ($module['stats'] as $stat) {
                                            $html .= '<div class="pull-left display-inline-block m-r-5">';
        ...
        if (count($admin_icons['data']) > 0) {
            foreach ($admin_icons['data'] as $data) {
                $html .= '<div class="icon-wrapper col-xs-6 col-sm-2 col-md-2 col-lg-2">';
                    $html .= '<a class="btn-app" href="'.$data['admin_link'].$aidlink.'" title="'.$data['admin_title'].'">';
